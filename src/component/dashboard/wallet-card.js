        ...
        <>
            <div className="card p-2 card-shadow"
                ...
                <div className="card-body">
                    <img className="mx-auto d-block mb-4" src="/wallet-img.png" alt=""/>
                    <h5 className="card-title mb-2 fw-bold text-center"
                        style={{fontSize: 16, color: "#3F8DFD"}}>Belum ada saldo di dompet!</h5>
                    <h5 className="card-title mb-4 fw-bold text-center" style={{fontSize: 16}}>Yuk isi
                        saldomu...</h5>
